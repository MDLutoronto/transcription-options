...
**Summary:** [aTrain](https://business-analytics.uni-graz.at/de/forschung/atrain/) is a free, open-source application you run locally on your computer. It will transcribe both your audio and video files, creating text files with speaker names and timestamps. aTrain combines [OpenAI's Whisper](https://github.com/openai/whisper) transcription models with speaker recognition and provides outputs that integrate with MAXQDA and ATLAS.ti.
...
[aTrain](https://business-analytics.uni-graz.at/de/forschung/atrain/) comes installed with the large-v3-turbo model to start, but you can select Models from the left menu and use the download buttons to download other models (generally the larger the model, the more accurate the transcription, but at a sacrifice to speed). You can read more about the models in the [documentation](https://github.com/openai/whisper).
