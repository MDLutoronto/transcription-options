...
Also, as mentioned, this only works for video files – see the Notes on [Converting Audio Only Files to Videos](https://mdlutoronto.github.io/transcription-options/cleaning-and-conversion/#notes-on-converting-audio-only-files-to-videos) section, if needed.
